...
public class Main {
    ...
    private static double avaliarRPN(List<String> rpn) {
        ...
        for (String token : rpn) {
            ...
            if (ehNumero(token)) {
                ...
                double resultado = calcular(primeiro, segundo, token);
            ...
            if (ehNumero(token)) {
                ...
                if (operadores.isEmpty()) {
                    ...
                    throw new IllegalArgumentException(
                            "parenteses fechando sem abertura correspondente."
                    );
                }
    ...
    private static List<String> tokenizar(String expressao) {
        ...
        while (i < expressao.length()) {
            ...
            if (Character.isDigit(caractere)
                    ...
                    || caractere == ','
                    || (caractere == '-'
                    && ehSinalNegativo(expressao, tokens, i))) {
                ...
                if (caractere == '-') {
                    ...
                    while (i < expressao.length()
                            && Character.isWhitespace(expressao.charAt(i))) {
                ...
                if (token.equals("-")
                    ...
                    throw new IllegalArgumentException(
                            "numero invalido perto de '" + token + "'."
                    );
                }
        ...
        if (tokens.isEmpty()) {
            ...
            throw new IllegalArgumentException(
                    "nenhuma expressao foi informada."
            );
        }
    ...
    private static boolean ehSinalNegativo(
            String expressao,
            List<String> tokens,
            int indice) {
        ...
        while (proximoIndice < expressao.length()
                && Character.isWhitespace(expressao.charAt(proximoIndice))) {
